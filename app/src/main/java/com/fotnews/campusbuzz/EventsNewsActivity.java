...
public class EventsNewsActivity extends BaseActivity {
    ...
    private void setupMoreOptionsMenu() {
        ...
        moreOptions.setOnClickListener(v -> {
            PopupMenu popupMenu = new PopupMenu(EventsNewsActivity.this, v);
    ...
    private void initializeViews() {
        ...
        bottomNavigationView.setSelectedItemId(R.id.tab_faculty);
    ...
    private void showNoNewsMessage() {
        ...
        noNewsText.setText("No faculty & events news available at the moment.");
